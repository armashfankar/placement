...
<div class="row">
		...
		<div class="box">
			<div class="box-content">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-styles">About You</label>
						<div class="col-sm-10">
	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			<div class="box-content">
				<div class="text-center">
                <h4 class="page-header">Educational Details</h4>
                    </div>
				<form class="form-horizontal" role="form">
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							<span><i class="fa fa-check-square-o txt-success"></i></span>
								Submit
							</button>
						</div>
					</div>
