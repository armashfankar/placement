...
--
-- Host: localhost
-- Generation Time: Mar 24, 2015 at 06:40 PM
...
INSERT INTO `department` (`did`, `username`, `password`) VALUES
(1, 'tabrez', 'tabrez');
...
(56, 'armash', 'Armash Aslam Fankar', '2015-03-10', 'male', 'B/02,RAHAT APT.BEHIND SHAHEEN HOSPITAL,KAUSA,MUMBRA', 'TRAVELLING', 'KALSEKAR TECHNICAL CAMPUS', 'MUMBAI UNIVERSITY', 'computer', '2014-2015', 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 0, 70, 70, 'python', 'JOB SERACH ENGINE', '', '', 0, '', '', ''),
...
(70, 'Firoz', 'Firoz Iqbal Memon', '20/9/1993', 'male', '240/D, Rabia Bldg., Adam Mistry Lane, Room No. 15, Parel, Mumbai - 400012', 'Listening Music', 'AIKTC', 'Mumbai University', 'computer', '2015', 55, 62, 62, 63, 62, 65, 73, 0, 63, 0, 0, 66, 79, 'java', 'Efficient Instant Messaging in Android', '', '', 0, '', '', ''),
